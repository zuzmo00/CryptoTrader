...
namespace Crypro.Migrations
{
    ...
    [Migration("20250604192506_addCascadeCrypto")]
    partial class addCascadeCrypto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crypro.Entities.LimitedTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Crypro.Entities.Wallet", b =>
                {
                    b.HasOne("Crypro.Entities.User", "User")
                        .WithOne("Wallet")
